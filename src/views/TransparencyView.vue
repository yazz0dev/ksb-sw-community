...
<template>
    <div class="container mt-4">
      <!-- Add wrapper div for specific styling -->
      <div class="transparency-content card card-body">
  ...
  *   **Escalation (if necessary):** If mediation is unsuccessful, a clear escalation path is defined.
      ...
      const renderedMarkdown = computed(() => {
        ...
        // Simple link target="_blank" addition (adjust regex if needed)
         const withTargetBlank = dirty.replace(/<a href=/g, '<a target="_blank" rel="noopener noreferrer" href=');
...
<style scoped>
/* Add minor scoped adjustments if needed, but most styles come from global */
