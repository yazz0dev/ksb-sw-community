        ...
        <form @submit.prevent="handleSubmit" v-else class="space-y-8">
            ...
            <div v-if="isTeamEvent" class="bg-white p-6 rounded-lg shadow border border-secondary space-y-6">
                ...
                <ManageTeamsComponent
                    :initial-teams="teams"
                    :students="availableStudentsWithoutOrganizers"
                    :nameCache="studentNameCache"
            ...
            <div class="mt-8 pt-6 border-t border-secondary">
                 <div class="flex justify-end">
                     <button type="submit" :disabled="isSubmitting || !isFormValid"
                             ...
                             class="inline-flex items-center rounded-md border border-transparent bg-primary px-6 py-2.5 text-sm font-medium text-black shadow-sm hover:bg-primary-dark focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-colors">
...
import { EventData, TeamMember, Student, RatingCriteria, EventStatus } from '../types/event'; // Assuming types are defined
...
const eventStatus = ref<EventStatus>('Approved'); // Default for new admin-created events
