      ...
      <div class="card-body">
        <div class="d-flex justify-content-between align-items-center">
             ...
             <button v-if="ratingsOpen && canRate"
                @click="goToRatingForm(team.teamName)" class="btn btn-info btn-sm btn-inline-mobile">
                <i class="fas fa-star me-1"></i> Rate Team
            </button>
        </div>

        <!-- Toggle Button -->
        <button @click="toggleTeamDetails(team.teamName)" class="btn btn-secondary btn-sm mt-2 mb-3 btn-inline-mobile"> 
        ...
        <div v-if="team.showDetails" class="list-group list-group-flush mt-2"> 
           ...
           <div v-else-if="team.members && team.members.length > 0">
                <div v-for="memberId in team.members" :key="memberId" class="list-group-item user-card-item px-0">
                    <p class="mb-0">
